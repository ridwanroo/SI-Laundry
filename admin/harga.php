				...
				while($d=mysqli_fetch_array($data)){
					...
					<form method="post" action="harga_update.php">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="harga" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" value="<?php echo $d['harga_per_kilo']; ?>">
						</div>		
