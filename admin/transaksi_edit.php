						...
						<table class="table table-bordered table-striped">
							...
							<div class="form-group alert alert-info">
								...
								<select class="form-control" name="status" required="required">										
									...
									<option <?php if($t['transaksi_status']=="3"){echo "selected='selected'";} ?> value="3">SETRIKA</option>
									<option <?php if($t['transaksi_status']=="4"){echo "selected='selected'";} ?> value="4">DI KEMAS</option>														
