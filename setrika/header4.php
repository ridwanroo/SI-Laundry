	...
	<nav class="navbar navbar-light" style="background-color: #ff7f0f" style="border-radius: 0px">
		<div class="container-fluid">			
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="setrika.php" style="color: #ffffff"><b>D&S</b> Laundry & Dry Cleaning</a>
			</div>
			
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="pencucian.php" class="text-success"><i class="glyphicon glyphicon-home"></i><b> Dashboard</b></a></li>
